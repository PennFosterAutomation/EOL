...
public class EOLCanadaEnrollNow_UI extends AbstractClass {

	WebDriver driver;
	String course;

	public EOLCanadaEnrollNow_UI(WebDriver driver) {
	...
	public void navigateToCanadaURLReciveInformation() {
		...
		Reporter.log(Utilities
				.logOutputFile("Click on Receive Information - Pass"));
	...
	public void varifyPageElementsForStep1() {
		...
		try {
			...
			Reporter.log(Utilities.logOutputFile(" Fill form for Course --> "
					+ courseNameHeadingOnStep1Page.getText() + " - Pass"));
			Assert.assertTrue(courseNameHeadingOnStep1Page.getText()
					.equalsIgnoreCase("HIGH SCHOOL"));
			Assert.assertTrue(courseMainNameHeadingOnStep1Page.getText()
					.equalsIgnoreCase("HIGH SCHOOL"));
			...
			Assert.assertTrue(copyrightTermsLinkonHeadingOnStep1Page
					.isDisplayed());
			Assert.assertTrue(privacyPolicyLinkonHeadingOnStep1Page
					.isDisplayed());
			...
			Assert.assertTrue(phoneTypeRadioButtonLabelOnStep1Page
					.isDisplayed());
			Assert.assertTrue(sendInformationButton.isDisplayed());
			Reporter.log(Utilities
					.logOutputFile(" Verify Elements display on Step1 page - Pass"));
		} catch (Exception e) {
			// System.out.println("Unable to Find Element on Step1 page --> " +
			// e);
		}
	}

	public void fillFormStep1ForCanada(String preFix, String Fname,
		...
		try {
			...
			// System.out.println("Error in validating all email message on Step1 page1 "
			// + e);
		}
		...
		try {
			...
			// System.out.println("Error in validating all email required message on Step1 page1 "
			// + e);
			okButtonValidationPopUp.click();
		}
		...
		try {
			...
			// System.out.println("Error in validating all email required message on Step1 page2 "
			// + e);
			okButtonValidationPopUp.click();
		}
	...
	public void verifyThnakYouPageAfterStep1FormPage() {
		...
		Reporter.log(Utilities
				.logOutputFile("Verify thank you page displayed  - PASS "));
		...
		Reporter.log(Utilities
				.logOutputFile("Click on Enroll OnLine Link  - PASS "));
	}
	...
	public void verifyPersonalInformationPage() {
		...
		Assert.assertTrue(firstNameTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(firstNameTextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(firstNameTextBoxOnStep1Page
				.getAttribute("value")
				.equalsIgnoreCase(
						Utilities
								.getYamlValue("CanadaURLReceiveInformation.StudentInformation.FirstName")));
		Assert.assertTrue(lastNameTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(lastNameTextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(lastNameTextBoxOnStep1Page.getAttribute("value")
				.equalsIgnoreCase(lname));
		Assert.assertTrue(emailTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(emailTextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(emailTextBoxOnStep1Page
				.getAttribute("value")
				.equalsIgnoreCase(
						email
								+ "@"
								+ Utilities
										.getYamlValue("CanadaURLReceiveInformation.StudentInformation.EmailExt")));
		Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(reTypeEmailTextBoxLabelOnStep1Page.isDisplayed());
		// System.out.println("email is : "
		// +reTypeEmailTextBoxOnStep1Page.getAttribute("value"));
		Assert.assertTrue(reTypeEmailTextBoxOnStep1Page
				.getAttribute("value")
				.equalsIgnoreCase(
						email
								+ "@"
		...
		Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(primaryPhoneTextBoxLabelOnStep1Page.isDisplayed());
		// System.out.println("primary phone is "
		// +primaryPhoneTextBoxOnStep1Page.getAttribute("value"));
		Assert.assertTrue(primaryPhoneTextBoxOnStep1Page
				.getAttribute("value")
				.equalsIgnoreCase(
						Utilities
								.getYamlValue("CanadaURLReceiveInformation.StudentInformation.PrimaryPhone")));
		Assert.assertTrue(address1TextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(address1TextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(address1TextBoxOnStep1Page
				.getAttribute("value")
				.equalsIgnoreCase(
						Utilities
								.getYamlValue("CanadaURLReceiveInformation.StudentInformation.Address")));
		Assert.assertTrue(address2TextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(address2TextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(cityTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(cityTextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(cityTextBoxOnStep1Page
				.getAttribute("value")
				.equalsIgnoreCase(
						Utilities
								.getYamlValue("CanadaURLReceiveInformation.StudentInformation.City")));
		Assert.assertTrue(ProvinceTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(ProvinceTextBoxLabelOnStep1Page.isDisplayed());
		Assert.assertTrue(PostalCodeTextBoxOnStep1Page.isDisplayed());
		Assert.assertTrue(PostalCodeTextBoxLabelOnStep1Page.isDisplayed());
		// System.out.println("actual pc "
		// +PostalCodeTextBoxOnStep1Page.getAttribute("value").replace(" ",
		// ""));
		// System.out.println("expected value "
		// +Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.ZIP").replace(" ",
		// ""));
		Assert.assertTrue(PostalCodeTextBoxOnStep1Page
				.getAttribute("value")
				.replace(" ", "")
				.equalsIgnoreCase(
						Utilities
								.getYamlValue(
										"CanadaURLReceiveInformation.StudentInformation.ZIP")
								.replace(" ", "")));
		Assert.assertTrue(communicateViaEmailCheckbox.isDisplayed());
		Assert.assertTrue(communicateViaEmailCheckboxLabel.isDisplayed());
		Assert.assertTrue(communicateViaTextMsgCheckbox.isDisplayed());
		...
		Assert.assertTrue(dobTextBoxLabelOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(monthTextboxDOBOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(dayTextboxDOBOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(yearTextboxDOBOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(levelOFEductionLabelOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(levelOFEductionDropDownOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(genderLabelOnStep1PersonalInformationPage
				.isDisplayed());
		Assert.assertTrue(genderDropDownOnStep1PersonalInformationPage
				.isDisplayed());
		...
		try {
			...
			Assert.assertTrue(step3TabOnEnrollmentFormForCanada.isDisplayed());
			Reporter.log(Utilities
					.logOutputFile("Verify textboxes and Labels display on Personal Information Page  - PASS "));

		} catch (Exception e) {
			// System.out.println("Unable to varify element on Personal Information Page --> "
			// + e);
			Reporter.log(Utilities
					.logOutputFile("Verify textboxes and Labels display on Personal Information Page  - FAIL "));
	...
	public void verificationPaymentInformationPage() {
		Reporter.log(Utilities
				.logOutputFile("Verify Course Name display on page i.e. "
						+ courseHaadingOnPaymentInformationPage.getText()
						+ " - PASS"));
		Assert.assertTrue(promoCodeOnPaymentInformationPage.isDisplayed());
		Reporter.log(Utilities
				.logOutputFile("Verify Promo COde Link display on Page - PASS"));
	...
	public void verifyElemetsOnPaymentInformationPage() {
		...
		courseCost = totalAmountFullPaymentPlanRadioOnPaymentInformationPage
				.getText();
		...
		Reporter.log(Utilities
				.logOutputFile("Verify Mode of Payment display on Payment Information Page - PASS"));
	...
	public boolean selectfullpaymentmodeOnPaymentInformationPage() {
		...
		if (str.contains("Please select your payment method:")
			...
			Reporter.log(Utilities
					.logOutputFile("Verify Options diplsy under Full Payment display on Payment Information Page - PASS"));
			if (Utilities.getYamlValue(
					"CanadaURLReceiveInformation.PaymentMode")
					.equalsIgnoreCase("Checking or Savings Account")) {
				savingsAccountRadioOnPaymentInformationPage.click();
				Reporter.log(Utilities
						.logOutputFile("Select savings account option display on Payment Information Page - PASS"));

			} else {
				creditCardRadioOnPaymentInformationPage.click();
				Reporter.log(Utilities
						.logOutputFile("Select creadit card option display on Payment Information Page - PASS"));
	...
	public void verifyElementOnCreditCardSectionOnPaymentInformationPage() {
		if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode")
				.equalsIgnoreCase("Checking or Savings Account")) {
			try {
				WebDriverWait wait = new WebDriverWait(driver, 10);
				wait.until(ExpectedConditions.visibilityOfElementLocated(By
						.xpath("//input[@id='ctl00_ctl00_MasterContentPlaceHolder_NestedMasterContentPlaceHolder_Form_txt_PaymentInfo_ACH_CAN_BankNumber']")));

				Assert.assertTrue(BankNumberTextPaymentInformationPage
						.isDisplayed());
				Assert.assertTrue(TransitNumberTextPaymentInformationPage
						.isDisplayed());
				Assert.assertTrue(AccountNumberTextPaymentInformationPage
						.isDisplayed());
			} catch (Exception e) {
				Reporter.log(Utilities
						.logOutputFile("Unable to verify Elements display on Payment Information Page --> Fail "));
				// System.out.println("Unable to verify Elements display on Payment Information Page --> "
				// + e);
			}
	...
	public void enterCreditCardInformationSectionOnPaymentInformationPage(
			String CreditCardNumber, String CVV) {

		if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode")
				.equalsIgnoreCase("Checking or Savings Account")) {
			BankNumberTextPaymentInformationPage.sendKeys(Utilities
					.getYamlValue("CanadaURLReceiveInformation.BankNumber"));
			TransitNumberTextPaymentInformationPage.sendKeys(Utilities
					.getYamlValue("CanadaURLReceiveInformation.TransitNumber"));
			AccountNumberTextPaymentInformationPage.sendKeys(Utilities
	...
	public boolean verifyElementsOnReviewAndSubmitPage(String preFix,
			String Fname, String Lname, String Mail, String EmailExt,
			String Phone, String Address, String City, String State,
			String Zip, String DOBmonth, String DOBday, String DOByear) {
		boolean result = true;
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By
				.xpath("//div[@class='agree_header']")));

		Reporter.log(Utilities
				.logOutputFile("Verify redirect user to review & submit page - PASS "));

		String PersonalInformation = p1.getText();
		if (PersonalInformation.contains("Personal Information")
				&& PersonalInformation.contains("Personal Information")
				&& PersonalInformation.contains("First Name:")
				&& PersonalInformation.contains("Last Name:")
				&& PersonalInformation.contains("Address:")
				&& PersonalInformation.contains("City:")
				&& PersonalInformation.contains("State:")
				&& PersonalInformation.contains("Zip Code:")
				&& PersonalInformation.contains("Country:")
				&& PersonalInformation.contains("Email:")
				&& PersonalInformation.contains("Phone (Other):")
				&& PersonalInformation.contains("Birth Date")) {
			Reporter.log(Utilities
					.logOutputFile("Information Display under Personal Information Heading - PASS "));

		} else {
			// System.out.println(p1.getText());
			result = false;
			Reporter.log(Utilities
					.logOutputFile("Information Display under Personal Information Heading - FAIL "));

			return result;
		}

		String ProgramInformation = p2.getText();
		if (ProgramInformation.contains("Program Information")
				&& ProgramInformation.contains("Program:")
				&& ProgramInformation.contains("Program Price:")
				&& ProgramInformation.contains("Initial Payment:")
				&& ProgramInformation.contains("Monthly Payment:")
				&& ProgramInformation.contains("# of Monthly Payments:")
				&& ProgramInformation.contains("Final Payment:")) {
			Reporter.log(Utilities
					.logOutputFile("Information Display under Program Information Heading - PASS "));

		} else {
			// System.out.println(p2.getText());
			result = false;
			Reporter.log(Utilities
					.logOutputFile("Information Display under Program Information Heading - FAIL "));
		...
		if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode")
				.equalsIgnoreCase("Checking or Savings Account")) {
			if (PaymentInformation.contains("Amount Charged Today")
					&& PaymentInformation.contains("Payment Information")
					&& PaymentInformation.contains("Account Number")
					&& PaymentInformation.contains("Monthly Payment:")) {
				Reporter.log(Utilities
						.logOutputFile("Information Display under Payment Information Heading - PASS "));
			} else {
				// System.out.println(p3.getText());
				result = false;
				Reporter.log(Utilities
						.logOutputFile("Information Display under Payment Information Heading - FAIL "));
			...
			if (PaymentInformation.contains("Amount Charged Today")
					&& PaymentInformation.contains("Payment Information")
					&& PaymentInformation.contains("Credit Card Number")
					&& PaymentInformation.contains("Exp. Date:")
					&& PaymentInformation.contains("Monthly Payment:")) {
				Reporter.log(Utilities
						.logOutputFile("Information Display under Payment Information Heading - PASS "));
			} else {
		...
		List<WebElement> check = driver.findElements(By
				.cssSelector("div[class^='column review-right']"));

		try {

			List<WebElement> editButton = driver.findElements(By
					.xpath(".//input[@value='Edit']"));
			...
			Assert.assertTrue(m
					...
					.contains(
							Utilities
									.getYamlValue("CanadaURLReceiveInformation.StudentInformation.DOBmonth")
									+ "/"
									+ Utilities
											.getYamlValue("CanadaURLReceiveInformation.StudentInformation.DOBday")
									+ "/"
									+ Utilities
											.getYamlValue("CanadaURLReceiveInformation.StudentInformation.DOByear")));
			...
			if (Utilities.getYamlValue(
					"CanadaURLReceiveInformation.PaymentMode")
					.equalsIgnoreCase("Credit or Debit Card")) {
				m = check.get(17);
				...
				String accountnumber = Utilities
						.getYamlValue("CanadaURLReceiveInformation.AccountNumber");
				Assert.assertTrue(m.getText().contains("XXX")
						&& m.getText().contains(
								accountnumber.subSequence(
	...
	public void acceptTermandConditionOnReviewAndSubmitPage() {
		Assert.assertTrue(checkboxLabelTermandConditionOnReviewAndSubmitPage
				.isDisplayed());
		...
		try {
			...
			if (Utilities.getYamlValue(
					"CanadaURLReceiveInformation.SignDocElectronically")
				...
				String FullName = Utilities
						.getYamlValue("CanadaURLReceiveInformation.StudentInformation.FirstName")
						+ " "
						+ Utilities
								.getYamlValue("CanadaURLReceiveInformation.StudentInformation.LastName");
				try {
					...
					Assert.assertTrue(StudentNameOnElectronicSigAgreement
							...
							.contains(
									Utilities
											.getYamlValue(
													"CanadaURLReceiveInformation.StudentInformation.FirstName")
											.toUpperCase()));
					Assert.assertTrue(StudentNameOnElectronicSigAgreement
					...
					Assert.assertTrue(StudentAddressOnElectronicSigAgreement
							...
							.contains(
									Utilities
											.getYamlValue(
													"CanadaURLReceiveInformation.StudentInformation.Address")
											.toUpperCase()));
					Assert.assertTrue(StudentAddressOnElectronicSigAgreement
							.getText()
							.contains(
									Utilities
											.getYamlValue(
													"CanadaURLReceiveInformation.StudentInformation.City")
											.toUpperCase()));
					Assert.assertTrue(StudentAddressOnElectronicSigAgreement
							.getText()
							.replace(" ", "")
					...
					Assert.assertTrue(EmailOnElectronicSigAgreement
							...
							.contains(
									email.toUpperCase()
											...
											+ Utilities
													.getYamlValue(
															"CanadaURLReceiveInformation.StudentInformation.EmailExt")
													.toUpperCase()));
			...
			WebDriverWait wait = new WebDriverWait(driver, 50);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By
					.xpath("//b[contains(text(),'Congratulations')]")));

			txtCongratulationsOnReviewAndSubmitPage.isDisplayed();
			Reporter.log(Utilities
					.logOutputFile(" Final Student ID not genrated application display only is Congratulations page"));
