...
public class EOLCanadaEnrollNow_nocourse_UI extends AbstractClass{
...
String course;
    ...
    public EOLCanadaEnrollNow_nocourse_UI(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
             
		@FindBy(xpath = "//form[@id='form7']/a")
		protected WebElement CanadaURLEnrollNowNoCourse;		
...
//		########### Message validation Payment Information Page  ######################
		...
		public void navigateToCanadaURLEnrollNowNoCourse()
        {       
			CanadaURLEnrollNowNoCourse.click();			
			Reporter.log(Utilities.logOutputFile("Click on Enroll Now (No course) - Pass"));
			Assert.assertTrue(ICSCanadaImage.isDisplayed());  
			Reporter.log(Utilities.logOutputFile("ICS Canada Image Verify - Pass"));

        }
		
		public int getCourseCountFromICSCanadaEnrollNowPage()
        {			
		...
		public void selectCourseFromCanadaEnrollNowNoCoursePage(String Course)
		{
...
//			#############################################################################
		...
		public void verifyPersonalInformationPage()	
		{
			try
			{
				...
				Assert.assertTrue(firstNameTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(firstNameTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(firstNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.FirstName")));
				Assert.assertTrue(lastNameTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(lastNameTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(lastNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(lname));
				Assert.assertTrue(emailTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(emailTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(emailTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(email+"@"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.EmailExt")));
				Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(reTypeEmailTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(email+"@"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.EmailExt")));
				Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(primaryPhoneTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.PrimaryPhone")));
				Assert.assertTrue(address1TextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(address1TextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(address1TextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.Address")));
				Assert.assertTrue(address2TextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(address2TextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(cityTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(cityTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(cityTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.City")));
				Assert.assertTrue(ProvinceTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(ProvinceTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(PostalCodeTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(PostalCodeTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(PostalCodeTextBoxOnStep1Page.getAttribute("value").replace(" ", "").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.ZIP").replace(" ", "")));
				Assert.assertTrue(communicateViaEmailCheckbox.isDisplayed());					
				Assert.assertTrue(communicateViaEmailCheckboxLabel.isDisplayed());					
				Assert.assertTrue(communicateViaTextMsgCheckbox.isDisplayed());					
				Assert.assertTrue(communicateViaTextMsgCheckboxLabel.isDisplayed());					
...
//		}
		...
		public boolean  selectfullpaymentmodeOnPaymentInformationPage(){
					...
					str.contains("Today's Payment:"))
			{
				...
				if (Utilities.getYamlValue("CanadaURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
				{					
		...
		if (Utilities.getYamlValue(
				"CanadaURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
			{ 
			try {
...
//				try{
//					WebDriverWait wait = new WebDriverWait(driver, 10 );
//					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@id='ctl00_ctl00_MasterContentPlaceHolder_NestedMasterContentPlaceHolder_Form_txt_PaymentInfo_ACH_CAN_BankNumber']")));
//				
...
//			}catch(Exception e)
			{
				...
				//System.out.println("Unable to verify Elements display on Payment Information Page1 --> "+e);
			}
				...
				// +Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.ZIP").replace(" ",
				// ""));
			...
			{
				//System.out.println("Unable to verify Elements display on Payment Information Page2 --> "+e);
			}
			}
		}
		...
		public void  enterCreditCardInformationSectionOnPaymentInformationPage1(String CreditCardNumber, String CVV)
		{
		
			if (Utilities.getYamlValue("CanadaURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
			{
				if(Utilities.getYamlValue("CanadaURLEnrollNownocourse.AccountType").equalsIgnoreCase("Checking"))
				{
				...
				routingNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("CanadaURLEnrollNownocourse.RoutingNumber"));
				accountNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("CanadaURLEnrollNownocourse.AccountNumber"));
...
//					Select select = new Select(accountTypesavingsAccountDropdownOnPaymentInformationPage);
//					select.selectByValue("C");
//					if (Utilities.getYamlValue("CanadaURLEnrollNownocourse").equalsIgnoreCase("AllCources")){
//						writeResult.writeColInExcelFile("Result", "Checking", currentCourseUI-1, 8);
//
//			        }else{
//			        	 if (Utilities.getYamlValue("CanadaURLEnrollNownocourse.RunType").equalsIgnoreCase("Selected")){
...
//				Reporter.log(Utilities.logOutputFile("Click on Proceed to Final Step button - PASS "));
				...
				BankNumberTextPaymentInformationPage.sendKeys(Utilities
						.getYamlValue("CanadaURLEnrollNownocourse.BankNumber"));
				TransitNumberTextPaymentInformationPage.sendKeys(Utilities
						.getYamlValue("CanadaURLEnrollNownocourse.TransitNumber"));
				AccountNumberTextPaymentInformationPage.sendKeys(Utilities
						.getYamlValue("CanadaURLEnrollNownocourse.AccountNumber"));
				proceedtoFinalStepCreditCardOnPaymentInformationPage.click();
				Reporter.log(Utilities
...
//				textElectronicSignature.getText().contains("Electronic Signature");
				...
				if (Utilities.getYamlValue(
						"CanadaURLEnrollNownocourse.SignDocElectronically")
					...
					String FullName = Utilities
							...
							+ " "
							+ Utilities
									.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.LastName");
					try {
						String DOB = Utilities
								.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.DOBmonth")
								+ "/"
								+ Utilities
										.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.DOBday")
								+ "/"
								+ Utilities
										.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.DOByear");
						...
						Assert.assertTrue(StudentNameOnElectronicSigAgreement
								...
								.contains(
										Utilities
												.getYamlValue(
														"CanadaURLEnrollNownocourse.StudentInformation.FirstName")
												.toUpperCase()));
						Assert.assertTrue(StudentNameOnElectronicSigAgreement
						...
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement
								...
								.contains(
										Utilities
												.getYamlValue(
														"CanadaURLEnrollNownocourse.StudentInformation.Address")
												.toUpperCase()));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement
								.getText()
								.contains(
										Utilities
												.getYamlValue(
														"CanadaURLEnrollNownocourse.StudentInformation.City")
												.toUpperCase()));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement
								.getText()
								.replace(" ", "")
						...
						Assert.assertTrue(EmailOnElectronicSigAgreement
								...
								.contains(
										email.toUpperCase()
												...
												+ Utilities
														.getYamlValue(
																"CanadaURLEnrollNownocourse.StudentInformation.EmailExt")
														.toUpperCase()));
					...
					textboxEmailOnElectronicSigAgreement
							.sendKeys(email
									+ "@"
									+ Utilities
											.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.EmailExt"));
