...
public class EOLCanadaEnrollNow_nocourse_Test {
	...
	{		
		if (Utilities.getYamlValue("CanadaURLEnrollNownocourse.RunType").equalsIgnoreCase("Selected")){
			...
			test.selectCourse(Utilities.getYamlValue("CanadaURLEnrollNownocourse.SelectCourse.Cource"+AllCourse_EOLCanadaEnrollNow_nocourse_Tests.initialCounter));				
...
//			test.selectCourse("A.S. DEGREE INTERIOR DESIGN");	
	...
	{		
		...
		CreditCardNumber = test.getYamlVal("CanadaURLEnrollNownocourse.StudentInformation.CreditCardNumber");
		CVV = test.getYamlVal("CanadaURLEnrollNownocourse.StudentInformation.CVV");
